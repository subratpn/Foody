	...
	<body>
		...
		<div class="container-fluid">
			...
			<div class="container-fluid" id="content">
				<div class="row">
					<c:forEach  var="hotel" items="${restaurants}">
					
						<div class="col">
							
								<div class="card hotel" style="width:250px">
									<img class="card-img-top" src="${hotel.image}" alt="Rest 1" style="width:100%; height:150px;">
										<div class="card-body">
											<center>
												<a href="./menu?hotelID=${hotel.id}&hotelName=${hotel.name}">
