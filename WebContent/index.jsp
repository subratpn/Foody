			...
			<div class="container-fluid" id="content">
				<div class="row">
					<div class="col">
						<a href="./menu.jsp">
							<div class="card hotel" style="width:250px">
								<img class="card-img-top" src="https://i.ibb.co/3Bvqw5T/rest1.jpg" alt="Rest 1" style="width:100%; height:150px;">
									<div class="card-body">
										<center>
					...
					<div class="col">
						<a href="./menu.jsp">
						<div class="card hotel" style="width:250px">
							<img class="card-img-top" src="https://i.ibb.co/8KX8dGx/rest2.jpg" alt="Rest 1" style="width:100%; height:150px;">
								<div class="card-body">
									<center>
					...
					<div class="col">
						<a href="./menu.jsp">
						<div class="card hotel" style="width:250px">
							<img class="card-img-top" src="https://i.ibb.co/mDhnNtn/rest3.jpg" alt="Rest 1" style="width:100%; height:150px;">
								<div class="card-body">
									<center>
					...
					<div class="col">
						<a href="./menu.jsp">
						<div class="card hotel" style="width:250px">
							<img class="card-img-top" src="https://i.ibb.co/86mx6qW/rest4.png" alt="Rest 1" style="width:100%; height:150px;">
								<div class="card-body">
									<center>
