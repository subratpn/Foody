				...
				<div class="row">
					<div class="col">
						<div class="card menu" style="width:200px">
							<img class="card-img-top" src="https://i.ibb.co/d55Hbwv/food1.jpg" alt="Menu 1" style="width:100%; height:150px;">
								<div class="card-body">
									<center>
					...
					<div class="col">
						<div class="card menu" style="width:200px">
							<img class="card-img-top" src="https://i.ibb.co/51dkfvH/food2.jpg" alt="Rest 1" style="width:100%; height:150px;">
								<div class="card-body">
									<center>
					...
					<div class="col">
						<div class="card menu" style="width:200px">
							<img class="card-img-top" src="https://i.ibb.co/ynj6YDc/food3.jpg" alt="Rest 1" style="width:100%; height:150px;">
								<div class="card-body">
									<center>
					...
					<div class="col">
						<div class="card menu" style="width:200px">
							<img class="card-img-top" src="https://i.ibb.co/c1KkK7B/food4.jpg" alt="Rest 1" style="width:100%; height:150px;">
								<div class="card-body">
									<center>
					...
					<div class="col">
						<div class="card menu" style="width:200px">
							<img class="card-img-top" src="https://i.ibb.co/jzHy2pv/food5.jpg" alt="Rest 1" style="width:100%; height:150px;">
								<div class="card-body">
									<center>
